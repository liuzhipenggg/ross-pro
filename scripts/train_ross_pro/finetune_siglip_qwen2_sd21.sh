...
EXP_NAME="ross-pro-siglip-qwen2-7b-sd21-kl8-mlp2x-pt558k-768-sft737k-768-ftclip-ftsd"
...
torchrun --nproc-per-node=8 --nnodes $1 --node_rank $2 \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/ross-pro-siglip-qwen2-7b-sd21-kl8-mlp2x-pt558k-768/mm_projector.bin \
    --pretrain_mm_inv_mlp_adapter ./checkpoints/ross-pro-siglip-qwen2-7b-sd21-kl8-mlp2x-pt558k-768/mm_inv_projector.bin \
