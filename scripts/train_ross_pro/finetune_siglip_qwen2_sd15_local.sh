#!/usr/bin/env bash
# Local SFT for: ross-pro-siglip-qwen2-7b-sd15-kl8-mlp2x-pt558k-xomni-sft737k-ftclip-ftsd
# Depends on PT adapters under:
#   $CKPT_ROOT/ross-pro-siglip-qwen2-7b-sd15-kl8-mlp2x-pt558k-xomni/{mm_projector,mm_inv_projector}.bin
#
