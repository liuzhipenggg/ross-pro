...
torchrun --nproc-per-node=8 --nnodes $1 --node_rank $2 \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/ross-pro-siglip-qwen2-7b-sd35-kl8-mlp2x-pt558k-xomni-ftsd/mm_projector.bin \
    --pretrain_mm_inv_mlp_adapter ./checkpoints/ross-pro-siglip-qwen2-7b-sd35-kl8-mlp2x-pt558k-xomni-ftsd/mm_inv_projector.bin \
    --output_dir ./checkpoints/$EXP_NAME \
    --vision_tower /root/paddlejob/siglip-so400m-patch14-384 \
    --version qwen_2 \
    --mm_pixel_decoder /root/paddlejob/stable-diffusion-3.5-medium/vae \
    \
