#!/usr/bin/env bash
# Local SFT for: ross-pro-siglip-qwen2-7b-sd3-kl8-mlp2x-pt558k-xomni-ftsd-sft737k-ftclip-ftsd
# Depends on PT adapters under:
#   $CKPT_ROOT/ross-pro-siglip-qwen2-7b-sd3-kl8-mlp2x-pt558k-xomni-ftsd/{mm_projector,mm_inv_projector}.bin
#
# Usage (tmux recommended):
#   source activate_ross.sh
#   bash scripts/train_ross_pro/finetune_siglip_qwen2_sd3_local.sh
set -euo pipefail
...
[[ -d "$SD3_PATH/vae" && -d "$SD3_PATH/transformer" ]] || {
