...
EXP_NAME="ross-pro-siglip-qwen2-7b-sd14-kl8-mlp2x-pt558k-sft737k"
...
torchrun --nproc-per-node=8 --nnodes $1 --node_rank $2 \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/ross-pro-siglip-qwen2-7b-sd14-kl8-mlp2x-pt558k/mm_projector.bin \
    --pretrain_mm_inv_mlp_adapter ./checkpoints/ross-pro-siglip-qwen2-7b-sd14-kl8-mlp2x-pt558k/mm_inv_projector.bin \
    ...
    --mm_inv_projector_type sd14_mlp2x \
