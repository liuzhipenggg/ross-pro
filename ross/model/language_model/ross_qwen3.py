...
class RossConfig(Qwen3Config):
    model_type = "ross_qwen3"


class RossQwen3Model(RossMetaModel, Qwen3Model):
    config_class = RossConfig

    def __init__(self, config: Qwen3Config):
        super(RossQwen3Model, self).__init__(config)


class RossQwen3ForCausalLM(Qwen3ForCausalLM, RossMetaForCausalLM):
    config_class = RossConfig

    def __init__(self, config):
        super(Qwen3ForCausalLM, self).__init__(config)
        self.model = RossQwen3Model(config)
...
AutoConfig.register("ross_qwen3", RossConfig)
AutoModelForCausalLM.register(RossConfig, RossQwen3ForCausalLM)
