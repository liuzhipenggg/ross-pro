...
class RossConfig(Qwen3MoeConfig):
    model_type = "ross_qwen3_moe"


class RossQwen3MoeModel(RossMetaModel, Qwen3MoeModel):
    config_class = RossConfig

    def __init__(self, config: Qwen3MoeConfig):
        super(RossQwen3MoeModel, self).__init__(config)


class RossQwen3MoeForCausalLM(Qwen3MoeForCausalLM, RossMetaForCausalLM):
    config_class = RossConfig

    def __init__(self, config):
        super(Qwen3MoeForCausalLM, self).__init__(config)
        self.model = RossQwen3MoeModel(config)
...
AutoConfig.register("ross_qwen3_moe", RossConfig)
AutoModelForCausalLM.register(RossConfig, RossQwen3MoeForCausalLM)
